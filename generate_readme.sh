...
# Generate README.md for platform-demo-principles
# Run from the repository root

OUTPUT="README.md"

# Check if tree is installed, otherwise use find
if command -v tree &> /dev/null; then
    # Exclude common non-source directories
    TREE_CMD="tree -I 'venv|__pycache__|*.pyc|node_modules|.git|build|dist|*.egg-info' --dirsfirst"
    PROJECT_STRUCTURE=$($TREE_CMD)
else
    PROJECT_STRUCTURE=$(find . -not -path './venv/*' \
